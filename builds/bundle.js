...
class FlipCounter {
  ...
  init(value) {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()("body").removeClass("play"); // if anything is playing
    ...
    function toIntArr(num) {
      var resultArray = [];
      if (num > 9999) console.log('Number exceeds 4 digits allowable.');else if (num == undefined) resultArray = [0, 0, 0, 0];else {
...
/* harmony export (immutable) */ __webpack_exports__["default"] = FlipCounter;
